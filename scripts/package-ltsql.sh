...
cp "$repo_root/bin/review.js" "$repo_root/bin/paste.js" "$repo_root/bin/clipboard.js" "$repo_root/bin/feedback.js" "$repo_root/bin/live-snapshot.js" "$package_root/bin/"
